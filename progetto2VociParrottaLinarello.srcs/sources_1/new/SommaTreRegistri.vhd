...
registrioIn: Registro generic map(16) port map(clk, clear, C, Q);
registroOut: Registro generic map(16) port map(clk, clear, S2, sum);
sommatore1: Sommatore generic map(16) port map(clk, clear, A, B, S1);
sommatore2: Sommatore generic map(16) port map(clk, clear, S1, Q, S2);
