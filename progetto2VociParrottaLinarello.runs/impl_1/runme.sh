...
HD_PWD='C:/Users/Greg/VivadoProjects/progetto2VociParrottaLinarello/progetto2VociParrottaLinarello.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SommaTreRegistri.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SommaTreRegistri.tcl -notrace
