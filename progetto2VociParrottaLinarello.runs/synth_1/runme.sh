...
HD_PWD='C:/Users/grego/vivadoProjects/progetto2VociParrottaLinarello/progetto2VociParrottaLinarello.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SommaTreRegistri.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SommaTreRegistri.tcl
