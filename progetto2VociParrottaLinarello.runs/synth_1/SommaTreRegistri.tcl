...
synth_design -top SommaTreRegistri -part xc7z020clg400-3


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef SommaTreRegistri.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file SommaTreRegistri_utilization_synth.rpt -pb SommaTreRegistri_utilization_synth.pb"
